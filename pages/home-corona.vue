<template>
  <div class="main-container">
    ...
    <div
      ...
      :style="{ backgroundImage: `url('/img/corona/slider.jpg')` }"
    >
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="hero-content-5 left">
              ...
              <n-link
                to="/about-us-01"
                class="brook-btn bk-btn-white btn-sd-size btn-rounded corona-btn space-between"
                >How to Protect</n-link
              >
              <n-link
                to="/contact-us-modern"
                class="brook-btn bk-btn-theme btn-sd-size btn-rounded corona-btn space-between"
                >Find a Doctor</n-link
              >
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="contagion-content wow move-up animate">
              ...
              <div class="brook-section-title-corona mb--50">
                <h2>
                  Contagion of <br />
                  Corona <span class="text-black text-underline">Covid19</span>
                </h2>
                <p>
                  Stay home, Stay safe and Stay healthy, Maintain at least 1
                  meter (3 feet) distance between yourself and who is coughing
                  or sneezing
                </p>
              </div>
              <!-- Section Title End -->
    ...
    <div
      ...
      :style="{ backgroundImage: `url('/img/bg/bg-image-137.jpg')` }"
    >
      <div
        ...
        <div class="row mb--70 mb_md--30 mb_sm--30">
          <div class="col-12">
            ...
            >
              ...
              <p>
                This is the symptom of the virus and how can you realize that
                <br />
                you are affected by this Coronavirus
              </p>
            </div>
            <!-- Section Title End -->
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 wow move-up animate">
            ...
            <div class="single-symptom mb--80 mb_md--30 mb_sm--30">
              ...
              <div class="symptom-content">
                <h3>Headache</h3>
                <p>
                  Headache is one of main symptom of causes coronavirus disease
                </p>
              </div>
            </div>
            <!-- Single symptom End -->
            ...
            <div class="single-symptom mb--80 mb_md--30 mb_sm--30">
              ...
              <div class="symptom-content">
                <h3>Fever</h3>
                <p>
                  Fever is also one of main symptom of causes coronavirus
                  disease
                </p>
              </div>
            </div>
            ...
            <div class="single-symptom mb--80 mb_md--30 mb_sm--30">
              ...
              <div class="symptom-content">
                <h3>Cough</h3>
                <p>
                  Cough the is one of main symptom of causes coronavirus disease
                </p>
              </div>
            </div>
            <!-- Single symptom End -->
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 wow move-up animate">
            ...
            <div class="single-symptom mb--80 mb_md--30 mb_sm--30">
              ...
              <div class="symptom-content">
                <h3>Sore Throat</h3>
                <p>
                  Sore Throat is another symptom of causes coronavirus disease
                </p>
              </div>
            </div>
            <!-- Single symptom End -->
            ...
            <div class="single-symptom mb--80 mb_md--30 mb_sm--30">
              ...
              <div class="symptom-content">
                <h3>Vomit</h3>
                <p>
                  Vomiting a is one of main symptom of causes coronavirus
                  disease
                </p>
              </div>
            </div>
            ...
            <div class="single-symptom mb--80 mb_md--30 mb_sm--30">
              ...
              <div class="symptom-content">
                ...
                <p>
                  Shortness of breath is the main symptom of coronavirus disease
                </p>
              </div>
            </div>
            <!-- Single symptom End -->
    ...
    <div
      class="prevenation-area bg_image--138 pt--110 pt_md--70 pt_sm--50 pb--40 pb_md--70 pb_sm--60"
      :style="{ backgroundImage: `url('/img/bg/bg-image-138.jpg')` }"
    >
      <div
        class="container-fluid plr--220 plr_lp--15 plr_lg--15 plr_md--15 plr_sm--15"
      >
              ...
              <div class="col-12">
                ...
                <div class="brook-section-title-corona wow move-up animate">
                  <h2>
                    Prevention of <br />
                    Coronavirus
                    <span class="text-black text-underline">Covid19</span>
                  </h2>
                  <p>
                    Stay home, Stay safe and Stay healthy, Maintain at least 1
                    meter (3 feet) <br />
    ...
    <!-- Faq Area Start -->
    <div
      class="faq-area pt--120 pt_md--80 pt_sm--60 pb--110 pb_md--40 pb_sm--20"
    >
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 wow move-up animate">
            <div class="faq-content">
              ...
              <p>
                You can learn information about Corona virus form here. If your
                have question check here and you can gate the answer. So don't
                be afraid be sage. moles tie virus.
              </p>
              <p>
                So learn information about Corona virus form here. If your have
                question check here and you can
              </p>
              <n-link
                to="/contact-us-modern"
                class="brook-btn bk-btn-theme btn-sd-size btn-rounded corona-btn space-between mt--20"
                >More Questions</n-link
              >
            </div>
          </div>
          <div class="col-lg-6 wow move-up animate">
            <div class="bk-accordion-style--2 border-style">
              <b-card no-body>
                ...
                <b-collapse id="accordion-11" visible accordion="my-accordion">
                  <b-card-body>
                    <b-card-text>
                      We learn from landing page's best practices and great
                      landing pages in order to create a clear, crisp design
                      that suits all your needs for a responsive landing site.
                    </b-card-text>
                  </b-card-body>
                </b-collapse>
              </b-card>
                ...
                <b-collapse id="accordion-22" visible accordion="my-accordion">
                  <b-card-body>
                    <b-card-text>
                      ...
                      both front-end & back-end developers to build their pages
                      with greater comfort thanks to the higher custom ability,
                ...
                <b-collapse id="accordion-33" visible accordion="my-accordion">
                  <b-card-body>
                    <b-card-text>
                      ...
                      & elements for particular projects with unlimited
    ...
    <div class="hand-wash-section pb--120 pb_md--80 pb_sm--60">
      <div
        class="container bg_image--139 bg-image"
        :style="{ backgroundImage: `url('/img/bg/bg-image-139.jpg')` }"
      >
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="row">
                  <div class="col-12 wow move-up animate">
                    <div
                      class="brook-section-title-corona mb--80 mb_lg--115 mb_md--30 mb_sm--30"
                    >
                      ...
                      <a
                        class="video-btn-text play__btn"
                        href="https://www.youtube.com/watch?v=5DGwOJXSxqg"
                        target="_blank"
                      >
              ...
              <div class="col-lg-6">
                <div class="row">
                  <div class="col-md-6 col-6 wow move-up animate">
                    <div
                      class="single-hand-wash mb--70 mb_lg--40 mb_md--30 mb_sm--30"
                    >
                      <div class="hand-wash-image">
    ...
    <!-- Blog Arae Start  -->
    <div
      class="blog-area bg_color--5 pt--105 pt_md--70 pt_sm--50 pb--120 pb_md--80 pb_sm--60"
    >
      <div class="container">
              ...
              <div class="post-content">
                <div class="post-inner">
                  <div class="post-categories">
                    <n-link to="/blog/blog-creative" class="theme-color"
                      >Life Style</n-link
                    >
                  </div>
                  ...
                  <div class="post-meta meta-corona">
                    ...
                    <div class="post-author">
                      by <n-link to="">Owen Christ</n-link>
                    </div>
                  </div>
                </div>
              </div>
